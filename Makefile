...
BlockKuzushi: raylib
ifneq (,$(BlockKuzushi_config))
	@echo "==== Building BlockKuzushi ($(BlockKuzushi_config)) ===="
	@${MAKE} --no-print-directory -C build/build_files -f BlockKuzushi.make config=$(BlockKuzushi_config)
endif
...
clean:
	@${MAKE} --no-print-directory -C build/build_files -f BlockKuzushi.make clean
